...
const Footer = () => {
    return (
      <Box> <Box  justifyContent="space-around" padding="2%" display="flex" justifyItems="center" alignItems="center" color="white" width="100%" height="50px" bgColor="rgb(22,137,205)">
