...
import { Box, Button, useToast,Modal,
    ModalOverlay,
    ModalContent,
    ModalFooter,
    ModalBody,
...
GetData()
    ...
    return (
      ...
      >
        <PopoverTrigger>
            <Button onClick={onToggle} colorScheme="red">Delete Post</Button></PopoverTrigger>
        <PopoverContent>
          ...
          <PopoverFooter display='flex' justifyContent='flex-end'>
            <ButtonGroup size='sm'>
              <Button onClick={isDelClose} variant='outline'>No</Button>
              <Button onClick={DeleteBlog} colorScheme='red'>Yes</Button>
            </ButtonGroup>
          </PopoverFooter>
        </PopoverContent>
      </Popover>
        ...
        <ModalContent>
          ...
          <FormControl
              ...
              paddingBottom={10}
            >
              <FormHelperText color="green" fontWeight="bold" fontSize="25px" textAlign="center">
                Edit Post
              </FormHelperText>
          ...
          <ModalFooter>
            <Button onClick={UpdateBlog} colorScheme="linkedin">Save</Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
